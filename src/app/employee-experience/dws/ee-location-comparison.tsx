      ...
      <main className="flex flex-col gap-5" style={EE_PERSPECTIVE_MAIN_STYLE}>
        <div style={{ maxWidth: 1320, margin: "0 auto", width: "100%" }} className="flex flex-col gap-5">
          ...
          <div className="rounded-2xl bg-white p-4" style={{ border: "1px solid #8798AA" }}>
            <label className="block text-[10px] font-bold uppercase tracking-[0.14em] text-[#6E7E96]">Statement</label>
            <select
              value={statementId}
              onChange={(e) => setStatementId(e.target.value)}
              className="mt-2 w-full rounded-[11px] border border-[#D4DAD6] bg-white px-3 py-2.5 text-[12.5px] font-semibold text-[#3B4B63]"
            >
