...
import { DashboardWithReadoutReturn } from "@/components/portal/dashboard-with-readout-return";
...
export default async function DashboardAssetPage({ params, searchParams }: DashboardAssetPageProps) {
  ...
  if (renderer) {
    ...
    if (renderedDashboard) {
      return <DashboardWithReadoutReturn>{renderedDashboard}</DashboardWithReadoutReturn>;
    }
  }

  return (
    <DashboardWithReadoutReturn>
