      ...
      <div className="space-y-8">
        ...
        <Card className="rounded-[28px] border-[#D6DEE3] bg-white shadow-sm">
          <CardHeader>
            ...
            <CardTitle className="pt-4 text-xl text-[#2B2B2B]">Document library</CardTitle>
            ...
            {documentAssets.map((asset) => (
              <div key={asset.id} className="rounded-2xl bg-[#F5F8FA] px-4 py-4">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-[#386B45]">
                    <FileText className="h-4 w-4" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-[#2B2B2B]">{asset.title}</p>
