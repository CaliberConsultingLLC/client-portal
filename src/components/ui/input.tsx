  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        id={inputId}
        className={cn(
          "flex h-11 w-full rounded-[--radius-md] border border-border-default bg-white px-4 py-2 text-sm text-text-primary shadow-sm transition-colors duration-[180ms] placeholder:text-text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-nsp-blue-400 focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
